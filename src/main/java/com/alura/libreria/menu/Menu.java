package com.alura.libreria.menu;

import com.alura.libreria.model.Autores;
import com.alura.libreria.model.DatosAutores;
import com.alura.libreria.model.DatosLibros;
...
import com.alura.libreria.service.ConvertirDatosAutores;
...
public class Menu {
    ...
    private final LibrosRepository repositorio1;
    ...
    public void buscarLibroPorElTitulo() {
        ...
        if(nombreDelLibro.isPresent()) {
            ...
            try {
                ...
                if (datosLibro != null) {
                    Optional<Libros> libroEnRepo = repositorio1.findAll().stream()
